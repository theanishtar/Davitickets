...
INSERT INTO showtime VALUES 
	 (1, 1, CAST('2023-08-17' AS Date), CAST('17:00:00' AS Time), CAST('19:30:00' AS Time), 75000),
	 (2, 1, CAST('2023-08-23' AS Date), CAST('08:00:00' AS Time), CAST('09:30:00' AS Time), 60000),
	 (3, 2, CAST('2023-08-14' AS Date), CAST('07:00:00' AS Time), CAST('09:00:00' AS Time), 50000),
	 (4, 2, CAST('2023-08-23' AS Date), CAST('09:00:00' AS Time), CAST('10:30:00' AS Time), 55000),
	 (5, 1, CAST('2023-08-07' AS Date), CAST('13:00:00' AS Time), CAST('14:20:00' AS Time), 45000),
	 (6, 1, CAST('2023-08-14' AS Date), CAST('13:20:00' AS Time), CAST('14:25:00' AS Time), 40000),
	 (7, 4, CAST('2023-08-30' AS Date), CAST('15:30:00' AS Time), CAST('17:10:00' AS Time), 65000),
	 (8, 3, CAST('2023-08-30' AS Date), CAST('10:00:00' AS Time), CAST('11:30:00' AS Time), 60000),
	 (9, 2, CAST('2023-08-07' AS Date), CAST('10:30:00' AS Time), CAST('12:30:00' AS Time), 50000),
	 (10, 5, CAST('2023-08-16' AS Date), CAST('14:00:00' AS Time), CAST('15:20:00' AS Time), 55000),
	 (11, 3, CAST('2023-08-30' AS Date), CAST('14:30:00' AS Time), CAST('16:01:00' AS Time), 45000),
	 (12, 4, CAST('2023-08-30' AS Date), CAST('07:00:00' AS Time), CAST('08:18:00' AS Time), 40000),
	 (13, 4, CAST('2023-08-23' AS Date), CAST('09:00:00' AS Time), CAST('10:17:00' AS Time), 65000)
...
INSERT INTO users VALUES 
	...
	(N'Lê Bích Vi', N'vilb', N'Nữ', '$2a$10$SvchmABRVVZjeLgOW4Dez.q7T1kcybCdiQF70DHKNs.nX30vmYLVi', N'0178296424', N'vilbpc04354@fpt.edu.vn', 'https://firebasestorage.googleapis.com/v0/b/davitickets-2e627.appspot.com/o/vilb.jpg?alt=media&token=83641b31-7ea9-432d-bd6b-4dd0f5e9062f', 1, 1, CAST('6-2-2003' AS DATE), CAST('7-22-2023' AS DATE), NULL),
...
INSERT INTO booking VALUES 
	(1, 27, 1, CAST('2023-07-17' AS Date), CAST('17:00:00' AS Time)),
	(1, 28, 2, CAST('2023-07-17' AS Date), CAST('7:00:00' AS Time)),
	(1, 29, 2, CAST('2023-07-17' AS Date), CAST('10:00:00' AS Time)),
	(1, 30, 2, CAST('2023-07-17' AS Date), CAST('12:00:00' AS Time)),
	(2, 38, 3, CAST('2023-08-17' AS Date), CAST('9:30:00' AS Time)), --ghe vip = gia goc + 10 ngan
	(1, 39, 4, CAST('2023-08-17' AS Date), CAST('10:00:00' AS Time)), --ghe vip = gia goc + 10 ngan
	(2, 51, 5, CAST('2023-08-17' AS Date), CAST('17:00:00' AS Time)) --ghe vip = gia goc + 10 ngan
...
INSERT INTO payment VALUES
	...
	(1, 75000, CAST('2023-07-17' AS Date)),
	(2, 75000,CAST('2023-07-17' AS Date)),
	(3, 75000, CAST('2023-07-17' AS Date)),
	(4, 75000, CAST('2023-07-17' AS Date)),
	(5, 70000,CAST('2023-08-17' AS Date)), --ghe vip = 60.000 + 10.000
	(6, 85000, CAST('2023-08-17' AS Date)), --ghe vip = 75.000 + 10.000
	(7, 70000, CAST('2023-08-17' AS Date)) --ghe vip = 60.000 + 10 ngan
...
SELECT movie FROM booking INNER JOIN payment ON payment.booking_id = booking.booking_id WHERE booking.userid = '2'

*/
/*
SELECT movie.title_movie, room.room_name, movie.duration, showtime.showdate, showtime.start_time, showtime.end_time, SUM(payment.total_amount) AS TOLAL FROM
booking INNER JOIN showtime ON showtime.showtime_id = booking.showtime_id
INNER JOIN movie ON movie.smovie_id = showtime.movie_id
INNER JOIN room ON room.room_id = showtime.room_id
INNER JOIN payment ON payment.booking_id = booking.booking_id WHERE booking.userid = '2'
GROUP BY movie.title_movie, room.room_name, movie.duration, showtime.showdate, showtime.start_time, showtime.end_time


Select count(seat.seat_id) from seat where seat.seat_id 
not in (select booking.seat_id from booking where booking.showtime_id = 2)
...
INSERT INTO showtime VALUES 
	 (3, 2, CAST('2023-08-15' AS Date), CAST('07:00:00' AS Time), CAST('09:00:00' AS Time), 50000),
	 (4, 2, CAST('2023-08-15' AS Date), CAST('09:00:00' AS Time), CAST('10:30:00' AS Time), 55000),
	 (1, 1, CAST('2023-08-15' AS Date), CAST('17:00:00' AS Time), CAST('19:30:00' AS Time), 75000),
	 (2, 1, CAST('2023-08-15' AS Date), CAST('08:00:00' AS Time), CAST('09:30:00' AS Time), 60000),
	 (3, 2, CAST('2023-08-15' AS Date), CAST('07:00:00' AS Time), CAST('09:00:00' AS Time), 50000),
	 (4, 2, CAST('2023-08-15' AS Date), CAST('09:00:00' AS Time), CAST('10:30:00' AS Time), 55000),
	 (1, 1, CAST('2023-08-15' AS Date), CAST('17:00:00' AS Time), CAST('19:30:00' AS Time), 75000),
	 (2, 1, CAST('2023-08-15' AS Date), CAST('08:00:00' AS Time), CAST('09:30:00' AS Time), 60000)

	 SELECT *FROM seat WHERE row_symbol='A' AND seat_num=1 AND room_id=1

	 SELECT * FROM booking WHERE userid=5 AND showtime_id =16 AND booking_date='2023-08-11' AND DATEPART(HOUR, CONVERT(DATETIME, booking_time, 8)) = 11 AND DATEPART(MINUTE, CONVERT(DATETIME, booking_time, 8)) = '02'